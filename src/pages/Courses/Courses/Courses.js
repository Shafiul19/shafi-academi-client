...
const Courses = () => {
    ...
    console.log(courses)
    return (
        <div className="grid lg:grid-cols-12 mt-28 text-slate-200 gap-5 w-10/12 mx-auto mt-10">
            <div className=" lg:col-span-3 bg-violet-500  shadow-xl rounded-lg  min-h-fit p-4">
                {courses.map((course) => (
